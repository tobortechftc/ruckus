...
//        com.vuforia.CameraDevice.getInstance().setField("iso", "800");
    ...
    public ToboDummy.MineralDetection.SampleLocation getGoldPositionTF(boolean isHanging) {
        ...
        ToboDummy.MineralDetection.SampleLocation sampleLocation = ToboDummy.MineralDetection.SampleLocation.UNKNOWN;
        int goldXCoord = -1;
        int silverXCoord = -1;
                        ...
                        if (validRecognitions >= 2) {
                            for (Recognition recognition :
                                ...
                                if (goldXCoord != -1 && goldXCoord < silverXCoord) {
                                    sampleLocation = ToboDummy.MineralDetection.SampleLocation.LEFT;
                                } else if (goldXCoord != -1 && goldXCoord > silverXCoord) {
                                    sampleLocation = ToboDummy.MineralDetection.SampleLocation.CENTER;
                                } else if (goldXCoord == -1 && silverXCoord != -1) {
                                    sampleLocation = ToboDummy.MineralDetection.SampleLocation.RIGHT;
                                }
                            }
                        }
                    }
    ...
    public ToboDummy.MineralDetection.SampleLocation getGoldPositionTF_Titan(boolean isHanging) {
        // The TFObjectDetector uses the camera frames from the VuforiaLocalizer, so we create that
        // first.
