...
public class TitanTeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        // -------------------------------------------------------------------------------
        // DO NOT set TURE for competition. May delay initialization and driving lentency
        boolean isDebugging = false; // true to enable imu and range sensors for debugging
        // -------------------------------------------------------------------------------

        telemetry.addData("Initializing Robot", "Please Wait ...");
        telemetry.update();

        ToboTitan robot = new ToboTitan();
        ...
        try {
            ...
            robot.configure(configuration, telemetry, isDebugging);
            configuration.apply();

            if (isDebugging) {
                robot.chassis.enableRangeSensorTelemetry();
                robot.chassis.enableImuTelemetry();
            }
